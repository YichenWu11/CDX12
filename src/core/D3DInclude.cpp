#include <CDX12/D3DInclude.h>

HRESULT __stdcall Chen::CDX12::D3DInclude::Open(
...
HRESULT __stdcall Chen::CDX12::D3DInclude::Close(LPCVOID pData) {
	char* buf = (char*)pData;
	delete[] buf;
	return S_OK;
}

HRESULT Chen::CDX12::DxcInclude::QueryInterface(REFIID riid, LPVOID* ppvObj)
{
...
ULONG STDMETHODCALLTYPE Chen::CDX12::DxcInclude::AddRef(void) {
	++m_cRef;
	return m_cRef;
}

ULONG STDMETHODCALLTYPE Chen::CDX12::DxcInclude::Release(void) {
	assert(m_cRef > 0);
	ULONG n = --m_cRef;
	if (0 == n)
		delete this;
...
void Chen::CDX12::DxcInclude::Clear() {
	for (char* buffer : buffers)
		delete[] buffer;
	buffers.clear();
}

HRESULT __stdcall Chen::CDX12::DxcInclude::LoadSource(

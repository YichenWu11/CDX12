...
namespace Ubpa::UDX12::FG {
	...
	private:
		...
		Chen::CDX12::DynamicSuballocMngr* csuDynamicDH{ nullptr };

		Chen::CDX12::DescriptorHeapAllocation csuDH;
		std::vector<UINT> csuDHfree;
		std::unordered_set<UINT> csuDHused;

		Chen::CDX12::DescriptorHeapAllocation rtvDH;
		std::vector<UINT> rtvDHfree;
		std::unordered_set<UINT> rtvDHused;

		Chen::CDX12::DescriptorHeapAllocation dsvDH;

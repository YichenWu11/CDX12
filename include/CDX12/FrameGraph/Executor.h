...
#include "../_deps/UFG/Compiler.hpp"
#include "../../../CTP/include/CTP/ThreadPool.hpp"
...
namespace Ubpa::UDX12::FG {
	...
	class Executor {
	public:
		using PassFunction = fu2::unique_function<void(ID3D12GraphicsCommandList*, const PassRsrcs&) const>;
